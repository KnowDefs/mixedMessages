...
const joke = () => {
  ...
  if (textInt < 3) {
    ...
    var string = 'Honestly, I can\'t stand this new ' + verb +'-' + animal + ' trend. I feel like this generation might be crazy!';

  } else {
    var string =  'With new advancements in technology, I can finally understand whay it\'s like to be a ' + verb + ' ' + animal + '! The only thing I wanted as a child!'
  }
  console.log(string);
}
